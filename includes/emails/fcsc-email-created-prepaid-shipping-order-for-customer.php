 ...
 *
 * @class       FCDS_F_WCS_EmailCreatedPrePaidShippingOrderForCustomer
 * @author 		Flycart
...
class FCDS_F_WCS_EmailCreatedPrePaidShippingOrderForCustomer extends WC_Email {
    ...
    function __construct() {
        ...
        $this->id                   = 'created_pre_paid_shipping_order_for_customer';
        $this->title                = __( 'Scheduled Delivery notification for customer', FCDS_F_WCS_TEXT_DOMAIN);
        ...
        // email template path
        $this->template_html    = 'emails/created-pre-paid-shipping-email-for-customer.php';
        $this->template_plain   = 'emails/created-pre-paid-shipping-email-for-customer.php';

        // Triggers for this email
        add_action( 'created_prepaid_shipping_order_email_for_customer_notification', array( $this, 'trigger' ), 10, 2 );
...
return new FCDS_F_WCS_EmailCreatedPrePaidShippingOrderForCustomer();